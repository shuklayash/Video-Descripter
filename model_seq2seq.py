...
if __name__ == '__main__':
    ...
    parser.add_argument('-e', '--num_epoches', type=int, default=5)
    ...
    parser.add_argument('-lo', '--load_saver', type=int, default=1)
    parser.add_argument('-at', '--with_attention', type=int, default=1)
    parser.add_argument('--data_dir', type=str, 
        default=('data/MLDS_hw2_1_data')
    )
    parser.add_argument('--test_dir', type=str, 
        default=('data/MLDS_hw2_1_data/testing_data')
    )
